...
public class DataPreparation {
    ...
    public static double[] stringToDoubleArray(String string) {
        ...
        for(int i=0;i<message.length();) {
            if (!sortedPhrases.contains(message.charAt(i))){
                i++;
                break;
            }
