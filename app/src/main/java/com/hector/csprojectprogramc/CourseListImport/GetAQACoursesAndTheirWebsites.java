...
public class GetAQACoursesAndTheirWebsites extends ExamBoardCourseListImporter { //Gets the list of courses from the AQA website
    ...
    private int timeout = 100000;//The initial timeout is 100 seconds
    ...
    protected HashMap<String, String> doInBackground(Void... voids) {
            ...
            final Activity activity = (Activity) context.get();
            ...
            try{
                ...
                final AlertDialog.Builder timeoutAlertDialogBuilder = new AlertDialog.Builder(context.get());//Initialises the builder which will create an alert dialog about the timeout
                ...
                final AlertDialog.Builder errorAlertDialogBuilder = new AlertDialog.Builder(context.get());//Initialises the builder which will create an alert about the error
